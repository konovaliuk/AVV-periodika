...
public final class ViewConstants {
    ...
    public static final String INPUT_PERIODICAL_DESCRIPTION = "description";
    ...
    public static final String INPUT_USER_ADDRESS = "address";
    public static final String INPUT_USER_EMAIL = "email";
    ...
    public static final String INPUT_SUBSCRIPTION_USER_ID = "user_id";

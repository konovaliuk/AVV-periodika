...
INSERT INTO `periodika`.`periodical` (`id`, `title`, `description`, `periodical_category_id`, `min_subscription_period`, `issues_per_period`, `price_per_period`) VALUES (6, 'ДЗЕРКАЛО ТИЖНЯ', 'Український суспільно-політичний тижневик, одне з найвпливовіших аналітичних видань в Україні', 1, 1, 4, 97.50);
